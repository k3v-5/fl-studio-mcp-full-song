...
from .tools import delivery as delivery_tools
...
from .tools.pie_foundation import register_pie_foundation_tools
from .tools.pie_governance import register_pie_governance_tools
from .tools.pie_music import register_pie_music_tools
from .tools.pie_arrangement import register_pie_arrangement_tools
from .tools.pie_sound_design import register_pie_sound_design_tools
from .tools.pie_digital_ear import register_pie_digital_ear_tools
from .tools.pie_project_hacker import register_pie_project_hacker_tools
from .tools import knowledge_theory as knowledge_theory_tools
from .tools import knowledge_producers as knowledge_producers_tools
from .tools import knowledge_plugins as knowledge_plugins_tools
from .tools import knowledge_mixing as knowledge_mixing_tools
from .tools import indexer as indexer_tools
from .tools import knowledge_learned as knowledge_learned_tools
from .tools import workflows as workflows_tools
...
def build_server() -> FastMCP:
    ...
    # PIE (Production Intelligence Engine) tool suites:
    register_pie_foundation_tools(mcp)
    register_pie_governance_tools(mcp)
    ...
    register_pie_project_hacker_tools(mcp)
    # Codigo-Neon / Franco Donati Deep Domain Knowledge & Indexer suites:
    knowledge_theory_tools.register(mcp)
    knowledge_producers_tools.register(mcp)
    knowledge_plugins_tools.register(mcp)
    knowledge_mixing_tools.register(mcp)
    indexer_tools.register(mcp)
    knowledge_learned_tools.register(mcp)
    workflows_tools.register(mcp)
    delivery_tools.register(mcp)
    return mcp
